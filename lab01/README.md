...
F5 — копирование файлов или папок.
F6 — переименование или перемещение файлов/папок.
F7 — создание новой папки.
F8 — удаление файлов или папок (в корзину или без).
F9 — вызов главного верхнего меню программы.
